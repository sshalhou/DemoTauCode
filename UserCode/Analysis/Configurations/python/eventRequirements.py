...
###########
# for high Mt + Same Sign
# used to get W normalization to be
# subtracted from QCD normalization



def pairCutsMuTau_forHighMtSameSign(chain, index, verbose):
  returnVal = True
  failChain = {}
  passChain = {}
  eventPar = {}
...
def pairCutsETau_forHighMtSameSign(chain, index, verbose):
  returnVal = True
  failChain = {}
  passChain = {}
  eventPar = {}
