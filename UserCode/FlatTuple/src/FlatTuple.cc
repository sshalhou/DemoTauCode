...
private:
  ...
  // object (i.e. this code is generated by make_variables.py using custom setting)

  std::vector< unsigned_int > run ;
  std::vector< unsigned_int > luminosityBlock ;
  std::vector< unsigned_int > event ;
