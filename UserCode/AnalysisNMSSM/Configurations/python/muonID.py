...
def muonIDforQCD(chain, index, printCutValues):
  returnVal = True
  failChain = {}
  passChain = {}
  muon = {}
  ...
  muon['relativeIso'] = chain.muT_muon_relativeIso_DR4[index]
  if (chain.muT_muon_relativeIso_DR4[index]<0.5 and chain.muT_muon_relativeIso_DR4[index]>0.2) is False:
    returnVal = False
    failChain['relativeIso'] = False
  else:
    passChain['relativeIso'] = True
    #print 'muon iso ',chain.muT_muon_relativeIso_DR4[index]
