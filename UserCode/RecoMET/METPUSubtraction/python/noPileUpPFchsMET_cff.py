...
pfCandidateToVertexAssociationForNoPileUpPFchsMEt = pfCandidateToVertexAssociation.clone(
...
noPileUpPFchsMEtSequence += pfCandidateToVertexAssociationForNoPileUpPFchsMEt
pfMETcorrType0ForNoPileUpPFchsMEt = pfMETcorrType0.clone(
    srcPFCandidateToVertexAssociations = cms.InputTag('pfCandidateToVertexAssociationForNoPileUpPFchsMEt')
)
noPileUpPFchsMEtSequence += pfMETcorrType0ForNoPileUpPFchsMEt
...
jvfJetIdForNoPileUpPFchsMEt = cms.EDProducer("JVFJetIdProducer",
    ...
    srcPFCandToVertexAssociations = cms.InputTag('pfCandidateToVertexAssociationForNoPileUpPFchsMEt'),
...
noPileUpPFchsMEt = cms.EDProducer("NoPileUpPFMEtProducer",
    ...
    srcType0Correction = cms.InputTag('pfMETcorrType0ForNoPileUpPFchsMEt'),                    
