...
from RecoMET.METPUSubtraction.mvaPFMET_leptons_42X_cfi                  import *
...
pfMEtMVA = cms.EDProducer("PFMETProducerMVA",
    ...
    inputFileNames = cms.PSet(
        U     = cms.FileInPath('RecoMET/METPUSubtraction/data/gbrmet_42.root'),
        DPhi  = cms.FileInPath('RecoMET/METPUSubtraction/data/gbrmetphi_42.root'),
        CovU1 = cms.FileInPath('RecoMET/METPUSubtraction/data/gbru1cov_42.root'),
        CovU2 = cms.FileInPath('RecoMET/METPUSubtraction/data/gbru2cov_42.root')
    ),
