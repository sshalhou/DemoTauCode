...
bool TupleElectronTau::isDecayZtauTau() const {return m_isDecayZtauTau;}


void TupleElectronTau::set_isDecayZeE(bool isDecayZeE_)
   {m_isDecayZeE  = isDecayZeE_; }
bool TupleElectronTau::isDecayZeE() const {return m_isDecayZeE;}


void TupleElectronTau::set_isDecayZmuMu(bool isDecayZmuMu_)
   {m_isDecayZmuMu  = isDecayZmuMu_; }
bool TupleElectronTau::isDecayZmuMu() const {return m_isDecayZmuMu;}


void TupleElectronTau::set_isRecoLep_matchedTo_GenTauFromZ(bool isRecoLep_matchedTo_GenTauFromZ_)
   {m_isRecoLep_matchedTo_GenTauFromZ  = isRecoLep_matchedTo_GenTauFromZ_; }
bool TupleElectronTau::isRecoLep_matchedTo_GenTauFromZ() const {return m_isRecoLep_matchedTo_GenTauFromZ;}


void TupleElectronTau::set_isRecoTau_matchedTo_GenTauFromZ(bool isRecoTau_matchedTo_GenTauFromZ_)
   {m_isRecoTau_matchedTo_GenTauFromZ  = isRecoTau_matchedTo_GenTauFromZ_; }
bool TupleElectronTau::isRecoTau_matchedTo_GenTauFromZ() const {return m_isRecoTau_matchedTo_GenTauFromZ;}


void TupleElectronTau::set_isRecoLep_matchedTo_GenElecFromZ(bool isRecoLep_matchedTo_GenElecFromZ_)
   {m_isRecoLep_matchedTo_GenElecFromZ  = isRecoLep_matchedTo_GenElecFromZ_; }
bool TupleElectronTau::isRecoLep_matchedTo_GenElecFromZ() const {return m_isRecoLep_matchedTo_GenElecFromZ;}


void TupleElectronTau::set_isRecoTau_matchedTo_GenElecFromZ(bool isRecoTau_matchedTo_GenElecFromZ_)
   {m_isRecoTau_matchedTo_GenElecFromZ  = isRecoTau_matchedTo_GenElecFromZ_; }
bool TupleElectronTau::isRecoTau_matchedTo_GenElecFromZ() const {return m_isRecoTau_matchedTo_GenElecFromZ;}


void TupleElectronTau::set_isRecoLep_matchedTo_GenMuonFromZ(bool isRecoLep_matchedTo_GenMuonFromZ_)
   {m_isRecoLep_matchedTo_GenMuonFromZ  = isRecoLep_matchedTo_GenMuonFromZ_; }
bool TupleElectronTau::isRecoLep_matchedTo_GenMuonFromZ() const {return m_isRecoLep_matchedTo_GenMuonFromZ;}


void TupleElectronTau::set_isRecoTau_matchedTo_GenMuonFromZ(bool isRecoTau_matchedTo_GenMuonFromZ_)
   {m_isRecoTau_matchedTo_GenMuonFromZ  = isRecoTau_matchedTo_GenMuonFromZ_; }
bool TupleElectronTau::isRecoTau_matchedTo_GenMuonFromZ() const {return m_isRecoTau_matchedTo_GenMuonFromZ;}


void TupleElectronTau::set_isRecoLep_matchedTo_GenElecFromTau(bool isRecoLep_matchedTo_GenElecFromTau_)
   {m_isRecoLep_matchedTo_GenElecFromTau  = isRecoLep_matchedTo_GenElecFromTau_; }
bool TupleElectronTau::isRecoLep_matchedTo_GenElecFromTau() const {return m_isRecoLep_matchedTo_GenElecFromTau;}


void TupleElectronTau::set_isRecoTau_matchedTo_GenElecFromTau(bool isRecoTau_matchedTo_GenElecFromTau_)
   {m_isRecoTau_matchedTo_GenElecFromTau  = isRecoTau_matchedTo_GenElecFromTau_; }
bool TupleElectronTau::isRecoTau_matchedTo_GenElecFromTau() const {return m_isRecoTau_matchedTo_GenElecFromTau;}


void TupleElectronTau::set_isRecoLep_matchedTo_GenMuonFromTau(bool isRecoLep_matchedTo_GenMuonFromTau_)
   {m_isRecoLep_matchedTo_GenMuonFromTau  = isRecoLep_matchedTo_GenMuonFromTau_; }
bool TupleElectronTau::isRecoLep_matchedTo_GenMuonFromTau() const {return m_isRecoLep_matchedTo_GenMuonFromTau;}


void TupleElectronTau::set_isRecoTau_matchedTo_GenMuonFromTau(bool isRecoTau_matchedTo_GenMuonFromTau_)
   {m_isRecoTau_matchedTo_GenMuonFromTau  = isRecoTau_matchedTo_GenMuonFromTau_; }
bool TupleElectronTau::isRecoTau_matchedTo_GenMuonFromTau() const {return m_isRecoTau_matchedTo_GenMuonFromTau;}
