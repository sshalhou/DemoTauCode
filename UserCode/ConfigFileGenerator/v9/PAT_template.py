...
process.TupleMuonTausNominalWeights = cms.EDProducer('TupleMuonTauWeightProducer' ,
                ...
                embedWeightSrc=cms.InputTag('generator','minVisPtFilter','EmbeddedRECO')
...
process.eTrigMatchEle27 = cms.EDProducer( "PATTriggerMatcherDRLessByR",
                                                       ...
                                                       matchedCuts = cms.string( 'path( "HLT_Ele27*" ) && type( "TriggerElectron" )' ),
...
process.eTrigMatchEle20 = cms.EDProducer( "PATTriggerMatcherDRLessByR",
                                                       src = cms.InputTag( 'cleanPatElectrons' ),
                                                       matched = cms.InputTag( 'patTrigger' ),
            matchedCuts = cms.string( 'path( "HLT_Ele20_CaloIdVT_CaloIsoRhoT_TrkIdT_TrkIsoT_LooseIsoPFTau20_v*" ) && type( "TriggerElectron" )' ),
                                                       maxDeltaR = cms.double( 0.5 ),
                                                       resolveAmbiguities = cms.bool( True ),
                                                       resolveByMatchQuality = cms.bool( True )
                                                       )
...
process.eTrigMatchEle22 = cms.EDProducer( "PATTriggerMatcherDRLessByR",
                                                       src = cms.InputTag( 'cleanPatElectrons' ),
                                                       matched = cms.InputTag( 'patTrigger' ),
            matchedCuts = cms.string( 'path( "HLT_Ele22_eta2p1_WP90Rho_LooseIsoPFTau20_v*" ) && type( "TriggerElectron" )' ),
                                                       maxDeltaR = cms.double( 0.5 ),
                                                       resolveAmbiguities = cms.bool( True ),
                                                       resolveByMatchQuality = cms.bool( True )
                                                       )
...
process.muTrigMatchMu17 = cms.EDProducer( "PATTriggerMatcherDRLessByR",
                                                       ...
                                                       matched = cms.InputTag( 'patTrigger' ),
            matchedCuts = cms.string( 'path( "HLT_IsoMu17_eta2p1_LooseIsoPFTau20_v*" )  && type( "TriggerMuon" )' ),
                                                       maxDeltaR = cms.double( 0.5 ),
                                                       resolveAmbiguities = cms.bool( True ),
                                                       resolveByMatchQuality = cms.bool( True )
                                                       )
...
process.muTrigMatchMu18 = cms.EDProducer( "PATTriggerMatcherDRLessByR",
                                                       src = cms.InputTag( 'cleanPatMuons' ),
                                                       matched = cms.InputTag( 'patTrigger' ),
            matchedCuts = cms.string( 'path( "HLT_IsoMu18_eta2p1_LooseIsoPFTau20_v*" ) && type( "TriggerMuon" )' ),
                                                       maxDeltaR = cms.double( 0.5 ),
                                                       resolveAmbiguities = cms.bool( True ),
                                                       resolveByMatchQuality = cms.bool( True )
                                                       )
...
process.muTrigMatchMu24 = cms.EDProducer( "PATTriggerMatcherDRLessByR",
                                                       src = cms.InputTag( 'cleanPatMuons' ),
                                                       matched = cms.InputTag( 'patTrigger' ),
            matchedCuts = cms.string( 'path( "HLT_IsoMu24*" ) && type( "TriggerMuon" )' ),
                                                       maxDeltaR = cms.double( 0.5 ),
                                                       resolveAmbiguities = cms.bool( True ),
                                                       resolveByMatchQuality = cms.bool( True )
                                                       )
...
process.tauTrigMatchEle20 = cms.EDProducer( "PATTriggerMatcherDRLessByR",
                                                       ...
                                                       matched = cms.InputTag( 'patTrigger' ),
            matchedCuts = cms.string( 'path( "HLT_Ele20_CaloIdVT_CaloIsoRhoT_TrkIdT_TrkIsoT_LooseIsoPFTau20_v*" ) && type( "TriggerTau" )' ),
                                                       maxDeltaR = cms.double( 0.5 ),
                                                       resolveAmbiguities = cms.bool( True ),
                                                       resolveByMatchQuality = cms.bool( True )
                                                       )
...
process.tauTrigMatchEle22 = cms.EDProducer( "PATTriggerMatcherDRLessByR",
                                                       src = cms.InputTag( 'cleanPatTaus' ),
                                                       matched = cms.InputTag( 'patTrigger' ),
            matchedCuts = cms.string( 'path( "HLT_Ele22_eta2p1_WP90Rho_LooseIsoPFTau20_v*" ) && type( "TriggerTau" )' ),
                                                       maxDeltaR = cms.double( 0.5 ),
                                                       resolveAmbiguities = cms.bool( True ),
                                                       resolveByMatchQuality = cms.bool( True )
                                                       )
...
process.tauTrigMatchMu17 = cms.EDProducer( "PATTriggerMatcherDRLessByR",
                                                       src = cms.InputTag( 'cleanPatTaus' ),
                                                       matched = cms.InputTag( 'patTrigger' ),
            matchedCuts = cms.string( 'path( "HLT_IsoMu17_eta2p1_LooseIsoPFTau20_v*" ) && type( "TriggerTau" )' ),
                                                       maxDeltaR = cms.double( 0.5 ),
                                                       resolveAmbiguities = cms.bool( True ),
                                                       resolveByMatchQuality = cms.bool( True )
                                                       )
...
process.tauTrigMatchMu18 = cms.EDProducer( "PATTriggerMatcherDRLessByR",
                                                       src = cms.InputTag( 'cleanPatTaus' ),
                                                       matched = cms.InputTag( 'patTrigger' ),
            matchedCuts = cms.string( 'path( "HLT_IsoMu18_eta2p1_LooseIsoPFTau20_v*" ) && type( "TriggerTau" )' ),
                                                       maxDeltaR = cms.double( 0.5 ),
                                                       resolveAmbiguities = cms.bool( True ),
                                                       resolveByMatchQuality = cms.bool( True )
                                                       )
...
process.tauTrigMatchJet320 = cms.EDProducer( "PATTriggerMatcherDRLessByR",
                                                       src = cms.InputTag( 'cleanPatTaus' ),
                                                       matched = cms.InputTag( 'patTrigger' ),
            matchedCuts = cms.string( 'path( "HLT_PFJet320*" ) && type( "TriggerJet" )' ),
                                                       maxDeltaR = cms.double( 0.5 ),
                                                       resolveAmbiguities = cms.bool( True ),
                                                       resolveByMatchQuality = cms.bool( True )
                                                       )
...
process.tauTrigMatchEle27 = cms.EDProducer( "PATTriggerMatcherDRLessByR",
                                                       src = cms.InputTag( 'cleanPatTaus' ),
                                                       matched = cms.InputTag( 'patTrigger' ),
                                                       matchedCuts = cms.string( 'path( "HLT_Ele27*" ) && type( "TriggerTau" )' ),
                                                       maxDeltaR = cms.double( 0.5 ),
                                                       resolveAmbiguities = cms.bool( True ),
                                                       resolveByMatchQuality = cms.bool( True )
                                                       )
...
process.tauTrigMatchMu24 = cms.EDProducer( "PATTriggerMatcherDRLessByR",
                                                       src = cms.InputTag( 'cleanPatTaus' ),
                                                       matched = cms.InputTag( 'patTrigger' ),
                                                       matchedCuts = cms.string( 'path( "HLT_IsoMu24*" ) &&  type( "TriggerTau" )' ),
                                                       maxDeltaR = cms.double( 0.5 ),
                                                       resolveAmbiguities = cms.bool( True ),
                                                       resolveByMatchQuality = cms.bool( True )
                                                       )
