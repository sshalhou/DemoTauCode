########################################################################################################
# import skeleton process and coreTools
########################################################################################################
...
# "particleFlow:electrons", use following line.
...
process.patDefaultSequence.replace( process.patElectrons, process.mvaIDelec * process.patElectrons )
...
process.mvametPATsequence = cms.Sequence(
                process.PFTau*
